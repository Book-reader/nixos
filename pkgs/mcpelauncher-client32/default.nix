...
/*    ++ lib.optionals (withQtWebview || withQtErrorWindow) [
  ...
  postInstall = ''
    mv $out/bin/mcpelauncher-client $out/bin/mcpelauncher-client32
  '';
  ...
  cmakeFlags = [
    ...
    (lib.cmakeBool "BUILD_X86" true)
  ];

  meta = {
    description = "Unofficial Minecraft Bedrock Edition launcher with CLI 32 bit version";
    ...
    mainProgram = "mcpelauncher-client32";
